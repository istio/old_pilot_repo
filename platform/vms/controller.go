...
func NewController(client *Client, config *Config, mesh *proxyconfig.ProxyMeshConfig) *Controller {
...
func (c *Controller) AppendConfigHandler(kind string, f func(Key, proto.Message, Event)) error {
	return nil
}

func (c *Controller) AppendServiceHandler(f func(*Service, Event)) error {
	return nil
}

func (c *Controller) AppendInstanceHandler(f func(*ServiceInstance, Event)) error {
	return nil
}

func (c *Controller) Run(stop <-chan struct{}) {}

func (c *Controller) Get(key Key) (proto.Message, bool) {
	return nil, nil
}

func (c *Controller) List(kind string, namespace string) (map[Key]proto.Message, error) {
	return nil, nil
}

func (c *Controller) Post(key Key, v proto.Message) error {
	return nil
}

func (c *Controller) Put(key Key, v proto.Message) error {
	return nil
}

func (c *Controller) Delete(key Key) error {
	return nil
}
