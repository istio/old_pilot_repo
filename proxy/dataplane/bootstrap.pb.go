...
import envoy_api_v27 "api"
import envoy_api_v28 "api"
...
func (*LightstepConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ZipkinConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*Tracing) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*Tracing_Http) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 0} }
...
type Admin struct {
	...
	Address *envoy_api_v21.Address `protobuf:"bytes,3,opt,name=address" json:"address,omitempty"`
}

func (m *Admin) Reset()                    { *m = Admin{} }
func (m *Admin) String() string            { return proto.CompactTextString(m) }
func (*Admin) ProtoMessage()               {}
func (*Admin) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (m *Admin) GetAddress() *envoy_api_v21.Address {
	if m != nil {
		return m.Address
	}
	return nil
...
type ClusterManager struct {
	...
	UpstreamBindConfig *envoy_api_v21.BindConfig `protobuf:"bytes,3,opt,name=upstream_bind_config,json=upstreamBindConfig" json:"upstream_bind_config,omitempty"`
	// A management server endpoint to stream load stats to, as per
	// StreamLoadStats in eds.proto. This must have api_type GRPC.
	LoadStatsConfig *envoy_api_v22.ApiConfigSource `protobuf:"bytes,4,opt,name=load_stats_config,json=loadStatsConfig" json:"load_stats_config,omitempty"`
}
...
func (*ClusterManager) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (m *ClusterManager) GetUpstreamBindConfig() *envoy_api_v21.BindConfig {
	if m != nil {
...
func (m *ClusterManager) GetLoadStatsConfig() *envoy_api_v22.ApiConfigSource {
	if m != nil {
...
func (*StatsdSink) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
type StatsdSink_Address struct {
	Address *envoy_api_v21.Address `protobuf:"bytes,1,opt,name=address,oneof"`
}
...
func (m *StatsdSink) GetAddress() *envoy_api_v21.Address {
...
func (*StatsSink) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*TagSpecifier) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*StatsConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*Watchdog) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*RateLimitServiceConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*Bootstrap) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }

func (m *Bootstrap) GetNode() *envoy_api_v22.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
type Bootstrap_StaticResources struct {
	Listeners []*envoy_api_v28.Listener `protobuf:"bytes,1,rep,name=listeners" json:"listeners,omitempty"`
	...
	Clusters []*envoy_api_v27.Cluster `protobuf:"bytes,2,rep,name=clusters" json:"clusters,omitempty"`
	Secrets  []*envoy_api_v26.Secret  `protobuf:"bytes,3,rep,name=secrets" json:"secrets,omitempty"`
}
...
func (*Bootstrap_StaticResources) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12, 0} }

func (m *Bootstrap_StaticResources) GetListeners() []*envoy_api_v28.Listener {
	if m != nil {
		return m.Listeners
	}
	return nil
...
func (m *Bootstrap_StaticResources) GetClusters() []*envoy_api_v27.Cluster {
	if m != nil {
		return m.Clusters
	}
	return nil
...
func (m *Bootstrap_StaticResources) GetSecrets() []*envoy_api_v26.Secret {
	if m != nil {
		return m.Secrets
	}
	return nil
...
type Bootstrap_DynamicResources struct {
	...
	LdsConfig *envoy_api_v22.ConfigSource `protobuf:"bytes,1,opt,name=lds_config,json=ldsConfig" json:"lds_config,omitempty"`
	// All post-bootstrap Cluster definitions are provided by a single CDS
	// configuration source.
	CdsConfig *envoy_api_v22.ConfigSource `protobuf:"bytes,2,opt,name=cds_config,json=cdsConfig" json:"cds_config,omitempty"`
	// A single ADS source may be optionally specified. This must have api_type GRPC.
	AdsConfig    *envoy_api_v22.ApiConfigSource           `protobuf:"bytes,3,opt,name=ads_config,json=adsConfig" json:"ads_config,omitempty"`
...
func (*Bootstrap_DynamicResources) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12, 1} }

func (m *Bootstrap_DynamicResources) GetLdsConfig() *envoy_api_v22.ConfigSource {
	if m != nil {
		return m.LdsConfig
	}
	return nil
...
func (m *Bootstrap_DynamicResources) GetCdsConfig() *envoy_api_v22.ConfigSource {
	if m != nil {
		return m.CdsConfig
	}
	return nil
...
func (m *Bootstrap_DynamicResources) GetAdsConfig() *envoy_api_v22.ApiConfigSource {
	if m != nil {
		return m.AdsConfig
	}
	return nil
...
type Bootstrap_DynamicResources_DeprecatedV1 struct {
	...
	SdsConfig *envoy_api_v22.ConfigSource `protobuf:"bytes,1,opt,name=sds_config,json=sdsConfig" json:"sds_config,omitempty"`
}
...
func (m *Bootstrap_DynamicResources_DeprecatedV1) GetSdsConfig() *envoy_api_v22.ConfigSource {
	if m != nil {
		return m.SdsConfig
	}
	return nil
...
func init() { proto.RegisterFile("api/bootstrap.proto", fileDescriptor0) }
