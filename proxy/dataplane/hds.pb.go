...
func (Capability_Protocol) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (*HealthCheckRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *HealthCheckRequest) GetNode() *envoy_api_v22.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
type EndpointHealth struct {
	...
	HealthStatus envoy_api_v23.HealthStatus `protobuf:"varint,2,opt,name=health_status,json=healthStatus,enum=envoy.api.v2.HealthStatus" json:"health_status,omitempty"`
}
...
func (*EndpointHealth) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *EndpointHealth) GetEndpoint() *envoy_api_v22.Endpoint {
	if m != nil {
		return m.Endpoint
	}
	return nil
...
func (m *EndpointHealth) GetHealthStatus() envoy_api_v23.HealthStatus {
	if m != nil {
		return m.HealthStatus
	}
	return envoy_api_v23.HealthStatus_UNKNOWN
}
...
func (*EndpointHealthResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
type LocalityEndpoints struct {
	...
	Endpoints []*envoy_api_v22.Endpoint `protobuf:"bytes,2,rep,name=endpoints" json:"endpoints,omitempty"`
}
...
func (*LocalityEndpoints) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *LocalityEndpoints) GetLocality() *envoy_api_v22.Locality {
	if m != nil {
		return m.Locality
	}
	return nil
...
func (m *LocalityEndpoints) GetEndpoints() []*envoy_api_v22.Endpoint {
	if m != nil {
		return m.Endpoints
	}
	return nil
...
type ClusterHealthCheck struct {
	...
	HealthChecks []*envoy_api_v23.HealthCheck `protobuf:"bytes,2,rep,name=health_checks,json=healthChecks" json:"health_checks,omitempty"`
...
func (*ClusterHealthCheck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (m *ClusterHealthCheck) GetHealthChecks() []*envoy_api_v23.HealthCheck {
	if m != nil {
...
func (*HealthCheckSpecifier) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func init() { proto.RegisterFile("api/hds.proto", fileDescriptor0) }
