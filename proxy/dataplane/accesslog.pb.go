...
type EnvoyAccessLog struct {
	...
	RequestMethod envoy_api_v22.RequestMethod `protobuf:"varint,1,opt,name=request_method,json=requestMethod,enum=envoy.api.v2.RequestMethod" json:"request_method,omitempty"`
	...
	RequestHeaders  []*envoy_api_v22.HeaderValue `protobuf:"bytes,26,rep,name=request_headers,json=requestHeaders" json:"request_headers,omitempty"`
	ResponseHeaders []*envoy_api_v22.HeaderValue `protobuf:"bytes,27,rep,name=response_headers,json=responseHeaders" json:"response_headers,omitempty"`
...
func (m *EnvoyAccessLog) GetRequestMethod() envoy_api_v22.RequestMethod {
	if m != nil {
...
func (m *EnvoyAccessLog) GetRequestHeaders() []*envoy_api_v22.HeaderValue {
	if m != nil {
...
func (m *EnvoyAccessLog) GetResponseHeaders() []*envoy_api_v22.HeaderValue {
	if m != nil {
