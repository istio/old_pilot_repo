...
func (TlsParameters_TlsProtocol) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }
...
func (*DataSource) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*TlsParameters) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*TlsCertificate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*TlsSessionTicketKeys) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*CertificateValidationContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*CommonTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*UpstreamTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*DownstreamTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
type SdsSecretConfig struct {
	...
	SdsConfig *envoy_api_v22.ConfigSource `protobuf:"bytes,2,opt,name=sds_config,json=sdsConfig" json:"sds_config,omitempty"`
}
...
func (*SdsSecretConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (m *SdsSecretConfig) GetSdsConfig() *envoy_api_v22.ConfigSource {
	if m != nil {
		return m.SdsConfig
	}
	return nil
...
func init() { proto.RegisterFile("api/sds.proto", fileDescriptor0) }
