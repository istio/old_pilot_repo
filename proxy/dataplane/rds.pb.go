...
type WeightedCluster_ClusterWeight struct {
	...
	MetadataMatch *envoy_api_v22.Metadata `protobuf:"bytes,3,opt,name=metadata_match,json=metadataMatch" json:"metadata_match,omitempty"`
}
...
func (m *WeightedCluster_ClusterWeight) GetMetadataMatch() *envoy_api_v22.Metadata {
	if m != nil {
...
type RouteMatch struct {
	...
	Runtime *envoy_api_v22.RuntimeUInt32 `protobuf:"bytes,5,opt,name=runtime" json:"runtime,omitempty"`
...
func (m *RouteMatch) GetRuntime() *envoy_api_v22.RuntimeUInt32 {
	if m != nil {
		return m.Runtime
	}
	return nil
...
type RouteAction struct {
	...
	// cluster with metadata matching that set in metadata_match will be
	// considered. The filter name should be specified as "envoy.lb".
	MetadataMatch *envoy_api_v22.Metadata `protobuf:"bytes,4,opt,name=metadata_match,json=metadataMatch" json:"metadata_match,omitempty"`
	...
	Priority            envoy_api_v22.RoutingPriority    `protobuf:"varint,11,opt,name=priority,enum=envoy.api.v2.RoutingPriority" json:"priority,omitempty"`
	// Specifies a set of headers that will be added to requests matching this
	// route.
	RequestHeadersToAdd []*envoy_api_v22.HeaderValueOption `protobuf:"bytes,12,rep,name=request_headers_to_add,json=requestHeadersToAdd" json:"request_headers_to_add,omitempty"`
...
func (m *RouteAction) GetMetadataMatch() *envoy_api_v22.Metadata {
	if m != nil {
		return m.MetadataMatch
	}
	return nil
...
func (m *RouteAction) GetPriority() envoy_api_v22.RoutingPriority {
	if m != nil {
		return m.Priority
	}
...
func (m *RouteAction) GetRequestHeadersToAdd() []*envoy_api_v22.HeaderValueOption {
	if m != nil {
...
type Route struct {
	...
	Metadata *envoy_api_v22.Metadata `protobuf:"bytes,4,opt,name=metadata" json:"metadata,omitempty"`
...
func (m *Route) GetMetadata() *envoy_api_v22.Metadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
type VirtualCluster struct {
	...
	// etc.
	Method envoy_api_v22.RequestMethod `protobuf:"varint,3,opt,name=method,enum=envoy.api.v2.RequestMethod" json:"method,omitempty"`
}
...
func (m *VirtualCluster) GetMethod() envoy_api_v22.RequestMethod {
	if m != nil {
		return m.Method
	}
	return envoy_api_v22.RequestMethod_METHOD_UNSPECIFIED
}
...
type VirtualHost struct {
	...
	RequestHeadersToAdd []*envoy_api_v22.HeaderValueOption `protobuf:"bytes,7,rep,name=request_headers_to_add,json=requestHeadersToAdd" json:"request_headers_to_add,omitempty"`
...
func (m *VirtualHost) GetRequestHeadersToAdd() []*envoy_api_v22.HeaderValueOption {
	if m != nil {
		return m.RequestHeadersToAdd
	}
	return nil
...
type RouteConfiguration struct {
	...
	ResponseHeadersToAdd []*envoy_api_v22.HeaderValueOption `protobuf:"bytes,4,rep,name=response_headers_to_add,json=responseHeadersToAdd" json:"response_headers_to_add,omitempty"`
	...
	RequestHeadersToAdd []*envoy_api_v22.HeaderValueOption `protobuf:"bytes,6,rep,name=request_headers_to_add,json=requestHeadersToAdd" json:"request_headers_to_add,omitempty"`
...
func (m *RouteConfiguration) GetResponseHeadersToAdd() []*envoy_api_v22.HeaderValueOption {
	if m != nil {
...
func (m *RouteConfiguration) GetRequestHeadersToAdd() []*envoy_api_v22.HeaderValueOption {
	if m != nil {
		return m.RequestHeadersToAdd
	}
	return nil
