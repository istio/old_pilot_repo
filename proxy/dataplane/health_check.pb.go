...
func (*HealthCheck_Payload) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (*HealthCheck_HttpHealthCheck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 1} }
...
func (*HealthCheck_TcpHealthCheck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 2} }
...
func (*HealthCheck_RedisHealthCheck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 3} }
...
func init() { proto.RegisterFile("api/health_check.proto", fileDescriptor0) }
