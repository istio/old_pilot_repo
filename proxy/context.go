...
func DefaultProxyConfig() proxyconfig.ProxyConfig {
	return proxyconfig.ProxyConfig{
		...
		DrainDuration:          ptypes.DurationProto(60 * time.Second),
		ParentShutdownDuration: ptypes.DurationProto(60 * time.Second),
		DiscoveryAddress:       "istio-pilot:8080",
		DiscoveryRefreshDelay:  ptypes.DurationProto(30 * time.Second),
		ZipkinAddress:          "",
...
func DefaultMeshConfig() proxyconfig.MeshConfig {
	...
	return proxyconfig.MeshConfig{
		...
		RdsRefreshDelay:       ptypes.DurationProto(30 * time.Second),
		EnableTracing:         true,
